...
wait(10)
cmd("TELESCOPE EXPOSURE_REQUEST with CCSDS_STREAMID 6545, CCSDS_SEQUENCE 49152, CCSDS_LENGTH 3, CCSDS_FUNCCODE 2, CCSDS_CHECKSUM 0, EXPOSURE_NUMBER #{exposureToScore}")    
